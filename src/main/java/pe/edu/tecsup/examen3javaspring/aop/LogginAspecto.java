package pe.edu.tecsup.examen3javaspring.aop;
...
import pe.edu.tecsup.examen3javaspring.domain.persistence.AuditoriaDao;
...
public class LogginAspecto {
    ...
    @Around("execution(* pe.edu.tecsup.examen3javaspring.services.*ServiceImpl.*(..))")
    ...
    @After("execution(* pe.edu.tecsup.examen3javaspring.controllers.*Controller.guardar*(..)) ||" +
            "execution(* pe.edu.tecsup.examen3javaspring.controllers.*Controller.editar*(..)) ||" +
            "execution(* pe.edu.tecsup.examen3javaspring.controllers.*Controller.eliminar*(..))")
